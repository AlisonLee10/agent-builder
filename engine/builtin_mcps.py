...
PRESET_MCPS: list[dict] = [
    ...
    },
    {
        ...
        "name":        "Gmail",
        "icon":        "📧",
        "description": "Send emails via Gmail (uses App Password — no OAuth browser flow needed)",
        "command":     "",
        "args":        [],
        "env_vars": [
            {"key": "GMAIL_ADDRESS",      "label": "Gmail Address (e.g. you@gmail.com)",                                        "required": True},
            {"key": "GMAIL_APP_PASSWORD", "label": "App Password (Google Account → Security → App Passwords, 16 chars, no spaces)", "required": True},
        ],
    },
    {
        "id":          "preset_github",
    ...
    },
    {
        ...
        "name":        "Discord",
        "icon":        "🎮",
        "description": "Post messages to Discord via an Incoming Webhook URL — no bot or channel ID needed",
        "command":     "",
        "args":        [],
        "env_vars": [
            {"key": "DISCORD_WEBHOOK_URL", "label": "Webhook URL (https://discord.com/api/webhooks/…)", "required": True},
        ],
    },
    {
        "id":          "preset_postgres",
